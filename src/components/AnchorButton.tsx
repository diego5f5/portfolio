...
export const AnchorButton = ({ label, iconSrc, ...rest }: IAnchorButton) => {
  return (
    <a
      {...rest}
      className="appearance-none rounded-full drop-shadow-lg bg-primary flex justify-center items-center h-10 min-w-[2.5rem] text-white tracking-wider hover:bg-hover transition-colors duration-300"
    >
